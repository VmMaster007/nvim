...
vim.opt.spelllang = { "en", "de" } -- Set language for spell checking
...
-- ripgrep is to search for files or for a specific text pattern

--Search Settings
vim.opt.ignorecase = true -- Case-insensitive search
vim.opt.smartcase = true -- Case-sensitive if uppercase is included in search
