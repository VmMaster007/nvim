...
M.on_attach = function(client, bufnr)
	...
	local opts = {
		...
		buffer = bufnr, -- restrict the buffer to the local keymap value
	}
	...
	keymap("n", "<leader>d", "<cmd>lua vim.diagnostic.open_float()<CR>", opts) -- cursor diagonostics
	...
	keymap("n", "<leader>gt", "<cmd>FzfLua lsp_typedefs<CR>", opts) -- jump to the type of definition of the symbol under the cursor
	...
	keymap("n", "<leader>gi", "<cmd>FzfLua lsp_implementation<CR>", opts) -- goto implementation
